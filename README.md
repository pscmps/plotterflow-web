...
- Jog初期値: 0.625 mm、30 mm/min（16マイクロステップ・6.4 steps/mmで4パルス）
- `ok` timeout: 30秒
...
- Jog: `$J=G91 G21 X... Y... F...`
- Job footer: `M122 P`を1回送信し、X/YのTMC2209状態を簡易診断します。
...
プロファイルを選択し直すとSerialタブのJog移動量と速度も即時に更新されます。Pico平面モータでは初回捕捉試験用に`0.625 mm / 30 mm/min`を設定します。
