...
- G-code Header: `M18`、`M980 U8 X100 Y100 H500 A1`、`M17`、`G21`、`G90`、`G10 L20 P0 X0 Y0`
- 初期化: `M18`、`M980 U8 X100 Y100 H500 A1`、`G21`、`G90`
- Job footer: `M122`、`M18`
- Feed初期値: 描画300mm/min、空走500mm/min
- Jog初期値: 0.625mm、300mm/min
- Jog: `$J=G91 G21 X... Y... F...`
...
100% dutyを表します。`A1`は移動軸だけ励磁し、X/Y単独移動時に停止軸をLowへします。斜め移動では
