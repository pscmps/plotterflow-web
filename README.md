...
- G-code Header: `M18`、`M980 U8 X100 Y100 H500`、`M17`、`G21`、`G90`、`G10 L20 P0 X0 Y0`
- 初期化: `M18`、`M980 U8 X100 Y100 H500`、`G21`、`G90`
- Job footer: `M122`、`M18`
...
100% dutyを表します。VM 3V、電源制限1.5A、各相1.5Ω直列抵抗から確認してください。
