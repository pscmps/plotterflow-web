...
- Empty parent components such as `SG90 v1:1` and `holder_rack v3:1` are not rendered as a duplicate mesh; their body-owning child occurrences are rendered instead.
