...
通常表示では、GRBL / FluidNC、STS3215 XYZ直結、カスタムの各プロファイルだけを表示します。試作中のXL330、TMC2209、DRV8835、M5Stack向けプロファイルを使用するときは、設定タブで「開発中機能を表示」を有効にしてください。開発中モードでは、対象プロファイルに付随する試験用Jog、SD管理、位置センサー／アーム校正などの専用操作も利用できます。
